...
```{r Eulerdiagrampng, fig.cap="Illustration of fully contained sets using the Euler diagram." }
...
```{r Eulerstep1, fig.cap="Displaying the steps for generating Euler Venn diagrams with pasted data matrix in two-column mode."}
...
```{r Eulerstylepng, fig.cap="Lists of more parameters. Hovering over the question mark to see detail information."}
...
```{r colorset, fig.cap="The way to set colors manually."}
knitr::include_graphics("image/color_set.png")
```

```{r ColorPicker, fig.cap="An animation showing adding, picking, removing and  clearing colors."}
